...
def _fri_config_from_kwargs(
    *,
    ...
    return FRIConfig(
        ...
        random_budget_distribution=str(cautious_kwargs.get("random_budget_distribution", "uniform")),
        random_budget_batch_mode=str(cautious_kwargs.get("random_budget_batch_mode", "independent")),
        random_budget_batch_std=float(cautious_kwargs.get("random_budget_batch_std", 0.08)),
        random_budget_loss_weight_mode=str(cautious_kwargs.get("random_budget_loss_weight_mode", "uniform")),
        ...
        budget_mask_noise_mode=str(cautious_kwargs.get("budget_mask_noise_mode", "")),
        budget_mask_noise_prob=float(cautious_kwargs.get("budget_mask_noise_prob", 0.0)),
        budget_mask_noise_density=float(cautious_kwargs.get("budget_mask_noise_density", float("nan"))),
        score_logit_noise_mode=str(cautious_kwargs.get("score_logit_noise_mode", "")),
        score_logit_noise_prob=float(cautious_kwargs.get("score_logit_noise_prob", 0.0)),
        score_logit_noise_force=float(cautious_kwargs.get("score_logit_noise_force", 4.0)),
        incumbent_dropout_prob=float(cautious_kwargs.get("incumbent_dropout_prob", 0.0)),
        incumbent_dropout_power=float(cautious_kwargs.get("incumbent_dropout_power", 1.0)),
