...
from src.packs.dinov2.dataset.builders import build_imagefolder_dataset
from src.packs.dinov2.models.adapters import create_dinov2_store
from src.packs.dinov2.models.model_loaders import load_dinov2_model
...
def load_model(
    ...
    **kwargs,
    ...
    """Create a DINOv2 model using either keyword or legacy positional arguments."""
