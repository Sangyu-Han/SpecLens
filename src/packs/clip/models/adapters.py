...
class CLIPVisionAdapter(ModelAdapter):
    """Adapter to run timm CLIP vision encoders inside the universal activation store."""
    ...
    def get_provenance_spec(self) -> Dict[str, Any]:
        # No prompts/UIDs required for CLIP vision encoder
        cols = ("sample_id", "y", "x")
...
def create_clip_store(
    ...
    adapter = CLIPVisionAdapter(model, device=cfg.get("device"))
...
__all__ = ["CLIPVisionAdapter", "create_clip_store", "CLIPBatchMeta"]
