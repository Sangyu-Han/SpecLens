...
class SiglipVisionAdapter(ModelAdapter):
    """Adapter to run timm SigLIP vision encoders inside the universal activation store."""
...
def create_siglip_store(
    ...
    adapter = SiglipVisionAdapter(model, device=cfg.get("device"))
...
__all__ = ["SiglipVisionAdapter", "create_siglip_store", "SiglipBatchMeta"]
